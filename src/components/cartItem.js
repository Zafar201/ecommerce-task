...
const CartItem = (props) => {
  ...
  return (
    <div className='flex justify-between items-center bg-slate-600 text-white p-2 border-b-2 border-slate-700 lg:gap-5 rounded-md'>
      {detail.image?.length > 0 && ( <img src={ detail?.image[0]} alt="" className='w-12'/>)} 
        <h3>{detail.name}</h3>
